...
def upgrade():
    ...
    sa.Column('traits', sa.String(length=500), nullable=True),
    sa.Column('ideals', sa.String(length=500), nullable=True),
    sa.Column('bonds', sa.String(length=500), nullable=True),
    sa.Column('flaws', sa.String(length=500), nullable=True),
